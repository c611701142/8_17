...
public:
    ...
    static constexpr int kEmptyCheck = 0x7FFFFFFF;
    static constexpr int kEmptyBase = 0x7FFFFFFF;
...
private:
    ...
    int forward(int r,uint8_t c){
        int t = bc_[r].base + c;
        bc_[t].check = r;
        expand(t + 1);//要素を加えるので、配列の成長
